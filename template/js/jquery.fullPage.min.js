    ...
    a.fn.fullpage = function(c) {
        ...
        function l(b, d, e) {
            ...
            if ("undefined" !== typeof g) {
                ...
                c.scrollingSpeed)) : (a.isFunction(c.onLeave) && !F && c.onLeave.call(this, q, r + 1, m), a(b).animate(f, c.scrollingSpeed, c.easing,
                function() {
                    l();
                    a.isFunction(c.afterLoad) && !F && c.afterLoad.call(this, u, r + 1);
                    setTimeout(function() {
        ...
        function V() {
            if (!G) {
                ...
                if (a.length) {
                    ...
                    f = "undefined" === typeof w && "undefined" === typeof b && !q; (a && a !== w && !c || f || !q && K != b) && L(a, b)
                }
            }
        }
        function k(b, d) {
        ...
        a.fn.fullpage.setAllowScrolling = function(b) {
            if (b) {
                if (a.fn.fullpage.setMouseWheelScrolling(!0), M || ca) MSPointer = aa(),
                a(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, fa),
                a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, ea)
            } else if (a.fn.fullpage.setMouseWheelScrolling(!1), M || ca) MSPointer = aa(),
        ...
        a(".fp-section").each(function(b) {
            ...
            a(this).css("height", n + "px"); (c.paddingTop || c.paddingBottom) && a(this).css("padding", c.paddingTop + " 0 " + c.paddingBottom + " 0");
            ...
            if (b.length) {
                var d = a('[data-anchor="' + b + '"]'); ! c.animateAnchor && d.length && (c.autoScrolling ? v(d.position().top) : (v(0), a("html, body").scrollTop(d.position().top)), I(b), J(b, null), a.isFunction(c.afterLoad) && c.afterLoad.call(this, b, d.index(".fp-section") + 1), d.addClass("active").siblings().removeClass("active"))
            }
            a(window).on("load",
            function() {
